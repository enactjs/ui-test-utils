const buildAppsPerformance = require('../src/build-apps-performance'),
	fs = require('fs');
let chalk;
...
const {configure} = require('../config/wdio.conf-performance.js');
...
exports.config = configure({
	 ...
	 */
	onPrepare: function () {
		return buildAppsPerformance('performance');
	},
	/**

...
function findViews () {
	return readdirp.promise(path.join('performance', 'apps'), {fileFilter: '*-View.js'});
}

function buildAppsPerformance (base) {
	...
	return import('chalk')
		...
		// 		epack({
		// 			directory: path.join('node_modules', '@enact', 'agate'),
		// 			file: {basename: 'Enact framework bundle', fullPath: 'framework'},
		// 			opts: [
		// 				'pack',
		// 				'--output',
		// 				path.join('performance', 'dist', 'framework'),
		// 				'--framework',
		// 				'--externals-polyfill'
		// 			]
		// 		});
		...
		// 		const ilibDist = path.join('performance', 'dist', 'framework', 'ilib');
		...
		// 						'--output',
		// 						path.join('performance', 'dist', path.basename(file.fullPath, '.js')),
		// 						'--externals',
		// 						'performance/dist/framework',
		// 						'--externals-polyfill'
		// 					]
		// 				})
		// 			))
...
function epack ({directory, file, opts}) {
	console.log(path.basename(file.fullPath, '.js'));
...
module.exports = buildAppsPerformance;
if (require.main === module) buildAppsPerformance();

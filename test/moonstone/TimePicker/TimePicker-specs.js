...
describe('TimePicker', function () {
	...
	describe('default', function () {
		...
		it('should be initially closed', function () {
			...
			expect(timePicker.picker1.isVisible()).to.be.false();
		});

		describe('5-way', function () {
			it('should open, spot first item on select, and update value to current time', function () {
				Page.open();
				...
				expect(timePicker.picker1.isVisible()).to.be.true();
				expect(timePicker.picker1.hasFocus()).to.be.true();
